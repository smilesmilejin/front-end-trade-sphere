...
function About() {
  return (
    <div className='about-container'>
      <h1>What Is TradeSphere?</h1>

      <section>
        <h2>👋  Introduction</h2>
        <p>TradeSphere is where local buyers and sellers come together. We’re seeing more hits every day — which means more eyes on your listings and better deals for everyone.</p>
      </section>
